...
def main():
    ...
    CLASSES = ('Car',             'Truck',        'Other vehicle bus',    'Sidewalk',
               'Other ground',    'Building',     'Fence',            'Vegetation',
               'Trunk',           'Terrain',      'Pole',             ' Traffic sign',
               '2 motor',         '2 bicycle',    '11 Traffic ')

    PALETTE_bgr = [[142, 0, 0], [70, 0, 0], [100, 60, 0],[232, 35, 244],
                   [128, 64, 128], [70, 70, 70],  [153, 153, 190],[35, 142, 107],
                   [156, 102, 102],  [152, 251, 152],[153, 153, 153],[0, 220, 220],
                   [230, 0, 0], [32, 11, 119],[30, 170, 250]]

    np_PALETTE = np.array(PALETTE_bgr)
    # dict data
    img_path = '/media/wan/bei/2021-7/SETR/demo/segment/'
    ...
    # img_0 in filenames:
        ...
        with open('./son1053/' + img_0.split('.')[0] + '.json', 'w') as json_file:
